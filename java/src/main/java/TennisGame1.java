...
public class TennisGame1 implements TennisGame {
    ...
    public String getScore() {
        ...
        if (m_score1 == m_score2 && m_score1 + m_score1 <= 4) {
            ...
            List<String> ployoffScores = Arrays.asList("Win for player2", "Advantage player2", "Deuce", "Advantage player1", "Win for player1");
            TreeMap<Integer, String> poScores = new TreeMap<Integer, String>() {{
